...
## CNV association analysis with a given pair of tuning parameters {.tabset}
...
<details><summary>(Click to unfold) CNV coefficient estimate with given parameters for a continuous outcome. </summary>
```{r}
QT_fit[2:20, ]
```
</details>
