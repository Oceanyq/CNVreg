## code used on HPC to simulate binary scenario 1 with CNVs in the middle of a 
## consecutive region as causal signals 
vi bnry_wt_S1Prtl.R
...
#causal segments
CNV_p1<-c(35:36, 148:149, 228:229)
p1=length(CNV_p1)
...
#average loss of 5 folds
    ...
    if(rep%%10==0){
    write.table(beta_cv,file = paste0(out_label[1],"cv",wt,out_label[2],".txt"), sep = "\t", row.names = FALSE)
    }  
}
